    ...
    <div className="wrap">
      <div className="sec-hd sr" data-n="03">
        <span className="sec-hd-icon" aria-hidden="true">
          <svg viewBox="1 1 22 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/><rect width="20" height="14" x="2" y="6" rx="2"/></svg>
        </span>
