...
function initWin3DCube() {
  ...
  const skills = [
    ...
    { name:'Node.js',      grad:['#0e3d1a','#07220e'], svg:`<svg viewBox="0 0 40 40" width="38" height="38"><polygon points="20,3 35.5,12 35.5,28 20,37 4.5,28 4.5,12" fill="none" stroke="#5FA04E" stroke-width="2.2"/><polygon points="20,7.5 31.5,14 31.5,26 20,32.5 8.5,26 8.5,14" fill="#3d7a34" opacity="0.3"/><text x="20" y="24" text-anchor="middle" font-family="'Arial Black',Arial,sans-serif" font-weight="900" font-size="9.5" fill="#5FA04E" letter-spacing="-0.3">node</text></svg>` },
